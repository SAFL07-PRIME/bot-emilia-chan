...
REPO_NAME: process.env.REPO_NAME || "emilia",
BOT_NAME: process.env.BOT_NAME || "emilia-chan",
DESCRIPTION: process.env.DESCRIPTION || "emilia PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "6283876338415",
